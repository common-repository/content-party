...
<div class="contentparty-body">
	...
	<header class="l-header">
		...
		<div class="m-navbar">
			<ul>
				<li><a href="admin.php?page=content_party_allpage_handle">總覽</a></li>
				<li class="is-curr"><a
						href="admin.php?page=content_party_topicpage_handle">話題</a></li>
	...
	<div class="l-content">
		<div class="m-table m-topic">
			<table>
				<tr>
					<th colspan="3">最新熱門話題</th>
				</tr>
				<tr>
					<td width="48%">
						<ul id="list1">
							<li><span>#1</span><a class="m-label">Loading...</a>
							</li>
							<li><span>#2</span><a class="m-label">Loading...</a>
							</li>
							<li><span>#3</span><a class="m-label">Loading...</a>
							</li>
							<li><span>#4</span><a class="m-label">Loading...</a>
							</li>
							<li><span>#5</span><a class="m-label">Loading...</a>
							</li>
							<li><span>#6</span><a class="m-label">Loading...</a>
							</li>
							<li><span>#7</span><a class="m-label">Loading...</a>
							</li>
							<li><span>#8</span><a class="m-label">Loading...</a>
							</li>
							<li><span>#9</span><a class="m-label">Loading...</a>
							</li>
							<li><span>#10</span><a class="m-label">Loading...</a>
							</li>
						</ul>
					</td>
					<td width="4%">&nbsp;</td>
					<td width="48%">
						<ul id="list2">
							<li><span>#11</span><a class="m-label">Loading...</a>
							</li>
							<li><span>#12</span><a class="m-label">Loading...</a>
							</li>
							<li><span>#13</span><a class="m-label">Loading...</a>
							</li>
							<li><span>#14</span><a class="m-label">Loading...</a>
							</li>
							<li><span>#15</span><a class="m-label">Loading...</a>
							</li>
							<li><span>#16</span><a class="m-label">Loading...</a>
							</li>
							<li><span>#17</span><a class="m-label">Loading...</a>
							</li>
							<li><span>#18</span><a class="m-label">Loading...</a>
							</li>
							<li><span>#19</span><a class="m-label">Loading...</a>
							</li>
							<li><span>#20</span><a class="m-label">Loading...</a>
							</li>
						</ul>
					</td>
				</tr>
