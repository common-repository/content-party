		...
		<header class="l-header">
			...
			<div class="m-navbar">
				<ul>
					...
					<li class="is-curr"><a
						href="admin.php?page=content_party_mediapage_handle">媒體來源</a></li>
				</ul>
			</div>
		</header>
		...
		<div class="l-content">
			<div class="m-source">
				<dl>
					<dt>熱門點閱(前30天)</dt>
					<dd>
						<div id="hot-media-list">
							<div class="m-souce-hot-more">
								<span class="m-label m-label-more" data-toggle
									data-toggle-target=".m-souce-hot-more"></span>
							</div>
						</div>
					</dd>
					...
					<dt>新進媒體來源(前7天)</dt>
					<dd>
						<div id="latest-media-list">
							<div class="m-souce-new-more">
								<span class="m-label m-label-more" data-toggle
									data-toggle-target=".m-souce-new-more"></span>
							</div>
						</div>
					</dd>
				</dl>
				...
				<div class="m-breadcrumb">
					媒體來源 / <span class="m-source-text"></span> <span
						class="m-source-clear"><i class="m-icon is-close"></i> 移除</span>
				</div>
			</div>
